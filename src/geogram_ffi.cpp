...
bool points_are_colinear_3d(const ::std::array<double, 3> &p1, const ::std::array<double, 3> &p2, const ::std::array<double, 3> &p3) {
    return GEO::PCK::points_are_colinear_3d(p1.data(), p2.data(), p3.data());
}
